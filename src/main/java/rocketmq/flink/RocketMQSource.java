...
import static rocketmq.flink.RocketMQConfig.*;
import static rocketmq.flink.RocketMQUtils.getInteger;
import static rocketmq.flink.RocketMQUtils.getLong;
    ...
    public void run(SourceContext context) throws Exception {
        ...
        pullConsumerScheduleService.registerPullTaskCallback(topic, new PullTaskCallback() {
            ...
            public void doPullTask(MessageQueue mq, PullTaskContext pullTaskContext) {
                ...
                long offset = 0;
                try {
                    offset = getMessageQueueOffset(mq);
                    ...
                    switch (pullResult.getPullStatus()) {
                        case FOUND:
                            ...
                            for (MessageExt msg : messages) {
                                ...
                                System.out.println("获取到的数据: "+data.toString());
