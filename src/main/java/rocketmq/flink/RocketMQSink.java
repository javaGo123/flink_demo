...
import rocketmq.flink.common.selector.TopicSelector;
import rocketmq.flink.common.serialization.KeyValueSerializationSchema;
...
public class RocketMQSink<IN> extends RichSinkFunction<IN> implements CheckpointedFunction {
    ...
    private Message prepareMessage(IN input) {
        ...
        System.out.println("sinkValue==== "+input.toString());
    ...
    public void close() throws Exception {
        System.out.println("rocketsin关闭");
        if (producer != null) {
            flushSync();
            producer.shutdown();
        }
